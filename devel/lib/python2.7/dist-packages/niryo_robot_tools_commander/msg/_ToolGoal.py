...
class ToolGoal(genpy.Message):
  _md5sum = "6a82b00a12ace7515f408f53824d53d8"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_2B2HBb().pack(_x.cmd.cmd_type, _x.cmd.tool_id, _x.cmd.gripper_close_speed, _x.cmd.gripper_open_speed, _x.cmd.activate, _x.cmd.gpio))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.cmd.cmd_type, _x.cmd.tool_id, _x.cmd.gripper_close_speed, _x.cmd.gripper_open_speed, _x.cmd.activate, _x.cmd.gpio,) = _get_struct_2B2HBb().unpack(str[start:end])
