...
(cl:in-package dynamixel_driver-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <SendCustomDxlValue-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SendCustomDxlValue-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dynamixel_driver-srv:<SendCustomDxlValue-request> is deprecated: use dynamixel_driver-srv:SendCustomDxlValue-request instead.")))

(cl:ensure-generic-function 'motor_type-val :lambda-list '(m))
(cl:defmethod motor_type-val ((m <SendCustomDxlValue-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dynamixel_driver-srv:motor_type-val is deprecated.  Use dynamixel_driver-srv:motor_type instead.")
  (motor_type m))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <SendCustomDxlValue-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dynamixel_driver-srv:id-val is deprecated.  Use dynamixel_driver-srv:id instead.")
  (id m))

(cl:ensure-generic-function 'value-val :lambda-list '(m))
(cl:defmethod value-val ((m <SendCustomDxlValue-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dynamixel_driver-srv:value-val is deprecated.  Use dynamixel_driver-srv:value instead.")
  (value m))

(cl:ensure-generic-function 'reg_address-val :lambda-list '(m))
(cl:defmethod reg_address-val ((m <SendCustomDxlValue-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dynamixel_driver-srv:reg_address-val is deprecated.  Use dynamixel_driver-srv:reg_address instead.")
  (reg_address m))

(cl:ensure-generic-function 'byte_number-val :lambda-list '(m))
(cl:defmethod byte_number-val ((m <SendCustomDxlValue-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dynamixel_driver-srv:byte_number-val is deprecated.  Use dynamixel_driver-srv:byte_number instead.")
  (byte_number m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SendCustomDxlValue-request>)))
  ...
  "dynamixel_driver/SendCustomDxlValueRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SendCustomDxlValue-request)))
  "Returns string type for a service object of type 'SendCustomDxlValue-request"
  "dynamixel_driver/SendCustomDxlValueRequest")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<SendCustomDxlValue-request>)))
  ...
  "a6060cddb14becf7546eae23209ccf2a")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'SendCustomDxlValue-request)))
  "Returns md5sum for a message object of type 'SendCustomDxlValue-request"
  "a6060cddb14becf7546eae23209ccf2a")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SendCustomDxlValue-request>)))
  ...
  (cl:format cl:nil "# Check XL-320 and XL-430 reference doc for~%# the complete register table~%~%int8 motor_type # 3 (XL-320) or 2 (XL-430)~%uint8 id~%int32 value~%int32 reg_address~%int32 byte_number~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SendCustomDxlValue-request)))
  "Returns full string definition for message of type 'SendCustomDxlValue-request"
  (cl:format cl:nil "# Check XL-320 and XL-430 reference doc for~%# the complete register table~%~%int8 motor_type # 3 (XL-320) or 2 (XL-430)~%uint8 id~%int32 value~%int32 reg_address~%int32 byte_number~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <SendCustomDxlValue-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SendCustomDxlValue-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dynamixel_driver-srv:<SendCustomDxlValue-response> is deprecated: use dynamixel_driver-srv:SendCustomDxlValue-response instead.")))

(cl:ensure-generic-function 'status-val :lambda-list '(m))
(cl:defmethod status-val ((m <SendCustomDxlValue-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dynamixel_driver-srv:status-val is deprecated.  Use dynamixel_driver-srv:status instead.")
  (status m))

(cl:ensure-generic-function 'message-val :lambda-list '(m))
(cl:defmethod message-val ((m <SendCustomDxlValue-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dynamixel_driver-srv:message-val is deprecated.  Use dynamixel_driver-srv:message instead.")
  (message m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SendCustomDxlValue-response>)))
  ...
  "dynamixel_driver/SendCustomDxlValueResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SendCustomDxlValue-response)))
  "Returns string type for a service object of type 'SendCustomDxlValue-response"
  "dynamixel_driver/SendCustomDxlValueResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SendCustomDxlValue)))
  ...
  "dynamixel_driver/SendCustomDxlValue")