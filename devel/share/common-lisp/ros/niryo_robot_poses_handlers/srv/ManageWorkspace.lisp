...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ManageWorkspace-request>)))
  ...
  "38f697145c1f24550e78559f024a0488")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ManageWorkspace-request)))
  "Returns md5sum for a message object of type 'ManageWorkspace-request"
  "38f697145c1f24550e78559f024a0488")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ManageWorkspace-request>)))
  ...
  (cl:format cl:nil "int32 SAVE = 1~%int32 SAVE_WITH_POINTS = 2~%int32 DELETE = -1~%~%int32 cmd~%~%niryo_robot_poses_handlers/Workspace workspace~%~%~%================================================================================~%MSG: niryo_robot_poses_handlers/Workspace~%string name # maximum lenght of workspace's name is 30 characters~%string description~%~%geometry_msgs/Point[] points~%niryo_robot_msgs/RobotState[] poses~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: niryo_robot_msgs/RobotState~%geometry_msgs/Point position~%niryo_robot_msgs/RPY rpy~%geometry_msgs/Quaternion orientation~%~%================================================================================~%MSG: niryo_robot_msgs/RPY~%# roll, pitch and yaw~%~%float64 roll~%float64 pitch~%float64 yaw~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ManageWorkspace-request)))
  "Returns full string definition for message of type 'ManageWorkspace-request"
  (cl:format cl:nil "int32 SAVE = 1~%int32 SAVE_WITH_POINTS = 2~%int32 DELETE = -1~%~%int32 cmd~%~%niryo_robot_poses_handlers/Workspace workspace~%~%~%================================================================================~%MSG: niryo_robot_poses_handlers/Workspace~%string name # maximum lenght of workspace's name is 30 characters~%string description~%~%geometry_msgs/Point[] points~%niryo_robot_msgs/RobotState[] poses~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: niryo_robot_msgs/RobotState~%geometry_msgs/Point position~%niryo_robot_msgs/RPY rpy~%geometry_msgs/Quaternion orientation~%~%================================================================================~%MSG: niryo_robot_msgs/RPY~%# roll, pitch and yaw~%~%float64 roll~%float64 pitch~%float64 yaw~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
