...
(cl:defmethod pin-val ((m <GetDigitalIO-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader niryo_robot_rpi-srv:pin-val is deprecated.  Use niryo_robot_rpi-srv:pin instead.")
  (pin m))
...
(cl:defmethod state-val ((m <GetDigitalIO-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader niryo_robot_rpi-srv:state-val is deprecated.  Use niryo_robot_rpi-srv:state instead.")
  (state m))
