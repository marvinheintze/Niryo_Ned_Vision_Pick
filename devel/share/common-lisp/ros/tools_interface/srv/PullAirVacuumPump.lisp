...
(cl:defmethod cl:initialize-instance :after ((m <PullAirVacuumPump-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PullAirVacuumPump-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tools_interface-srv:<PullAirVacuumPump-request> is deprecated: use tools_interface-srv:PullAirVacuumPump-request instead.")))
...
(cl:defmethod pull_air_position-val ((m <PullAirVacuumPump-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tools_interface-srv:pull_air_position-val is deprecated.  Use tools_interface-srv:pull_air_position instead.")
  (pull_air_position m))
...
(cl:defmethod pull_air_hold_torque-val ((m <PullAirVacuumPump-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tools_interface-srv:pull_air_hold_torque-val is deprecated.  Use tools_interface-srv:pull_air_hold_torque instead.")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<PullAirVacuumPump-request>)))
  ...
  "tools_interface/PullAirVacuumPumpRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'PullAirVacuumPump-request)))
  "Returns string type for a service object of type 'PullAirVacuumPump-request"
  "tools_interface/PullAirVacuumPumpRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <PullAirVacuumPump-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PullAirVacuumPump-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tools_interface-srv:<PullAirVacuumPump-response> is deprecated: use tools_interface-srv:PullAirVacuumPump-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<PullAirVacuumPump-response>)))
  ...
  "tools_interface/PullAirVacuumPumpResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'PullAirVacuumPump-response)))
  "Returns string type for a service object of type 'PullAirVacuumPump-response"
  "tools_interface/PullAirVacuumPumpResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'PullAirVacuumPump)))
  ...
  "tools_interface/PullAirVacuumPump")