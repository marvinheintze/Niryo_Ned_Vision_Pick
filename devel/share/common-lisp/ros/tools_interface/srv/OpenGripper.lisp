...
(cl:defmethod cl:initialize-instance :after ((m <OpenGripper-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'OpenGripper-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tools_interface-srv:<OpenGripper-request> is deprecated: use tools_interface-srv:OpenGripper-request instead.")))
...
(cl:defmethod open_position-val ((m <OpenGripper-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tools_interface-srv:open_position-val is deprecated.  Use tools_interface-srv:open_position instead.")
  (open_position m))

(cl:ensure-generic-function 'open_speed-val :lambda-list '(m))
(cl:defmethod open_speed-val ((m <OpenGripper-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tools_interface-srv:open_speed-val is deprecated.  Use tools_interface-srv:open_speed instead.")
  (open_speed m))

(cl:ensure-generic-function 'open_hold_torque-val :lambda-list '(m))
(cl:defmethod open_hold_torque-val ((m <OpenGripper-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tools_interface-srv:open_hold_torque-val is deprecated.  Use tools_interface-srv:open_hold_torque instead.")
  (open_hold_torque m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<OpenGripper-request>)))
  ...
  "tools_interface/OpenGripperRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'OpenGripper-request)))
  "Returns string type for a service object of type 'OpenGripper-request"
  "tools_interface/OpenGripperRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <OpenGripper-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'OpenGripper-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tools_interface-srv:<OpenGripper-response> is deprecated: use tools_interface-srv:OpenGripper-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<OpenGripper-response>)))
  ...
  "tools_interface/OpenGripperResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'OpenGripper-response)))
  "Returns string type for a service object of type 'OpenGripper-response"
  "tools_interface/OpenGripperResponse")
