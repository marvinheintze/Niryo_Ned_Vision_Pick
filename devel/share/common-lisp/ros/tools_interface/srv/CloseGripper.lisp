...
(cl:defmethod cl:initialize-instance :after ((m <CloseGripper-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CloseGripper-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tools_interface-srv:<CloseGripper-request> is deprecated: use tools_interface-srv:CloseGripper-request instead.")))
...
(cl:defmethod close_position-val ((m <CloseGripper-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tools_interface-srv:close_position-val is deprecated.  Use tools_interface-srv:close_position instead.")
  (close_position m))

(cl:ensure-generic-function 'close_speed-val :lambda-list '(m))
(cl:defmethod close_speed-val ((m <CloseGripper-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tools_interface-srv:close_speed-val is deprecated.  Use tools_interface-srv:close_speed instead.")
  (close_speed m))

(cl:ensure-generic-function 'close_hold_torque-val :lambda-list '(m))
(cl:defmethod close_hold_torque-val ((m <CloseGripper-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tools_interface-srv:close_hold_torque-val is deprecated.  Use tools_interface-srv:close_hold_torque instead.")
  (close_hold_torque m))

(cl:ensure-generic-function 'close_max_torque-val :lambda-list '(m))
(cl:defmethod close_max_torque-val ((m <CloseGripper-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tools_interface-srv:close_max_torque-val is deprecated.  Use tools_interface-srv:close_max_torque instead.")
  (close_max_torque m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<CloseGripper-request>)))
  ...
  "tools_interface/CloseGripperRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CloseGripper-request)))
  "Returns string type for a service object of type 'CloseGripper-request"
  "tools_interface/CloseGripperRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <CloseGripper-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CloseGripper-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tools_interface-srv:<CloseGripper-response> is deprecated: use tools_interface-srv:CloseGripper-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<CloseGripper-response>)))
  ...
  "tools_interface/CloseGripperResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CloseGripper-response)))
  "Returns string type for a service object of type 'CloseGripper-response"
  "tools_interface/CloseGripperResponse")
