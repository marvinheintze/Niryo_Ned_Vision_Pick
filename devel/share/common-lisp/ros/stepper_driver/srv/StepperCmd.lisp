...
(cl:in-package stepper_driver-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <StepperCmd-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StepperCmd-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name stepper_driver-srv:<StepperCmd-request> is deprecated: use stepper_driver-srv:StepperCmd-request instead.")))

(cl:ensure-generic-function 'cmd_type-val :lambda-list '(m))
(cl:defmethod cmd_type-val ((m <StepperCmd-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader stepper_driver-srv:cmd_type-val is deprecated.  Use stepper_driver-srv:cmd_type instead.")
  (cmd_type m))

(cl:ensure-generic-function 'motors_id-val :lambda-list '(m))
(cl:defmethod motors_id-val ((m <StepperCmd-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader stepper_driver-srv:motors_id-val is deprecated.  Use stepper_driver-srv:motors_id instead.")
  (motors_id m))

(cl:ensure-generic-function 'params-val :lambda-list '(m))
(cl:defmethod params-val ((m <StepperCmd-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader stepper_driver-srv:params-val is deprecated.  Use stepper_driver-srv:params instead.")
  (params m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<StepperCmd-request>)))
  ...
  "stepper_driver/StepperCmdRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'StepperCmd-request)))
  "Returns string type for a service object of type 'StepperCmd-request"
  "stepper_driver/StepperCmdRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <StepperCmd-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StepperCmd-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name stepper_driver-srv:<StepperCmd-response> is deprecated: use stepper_driver-srv:StepperCmd-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <StepperCmd-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader stepper_driver-srv:result-val is deprecated.  Use stepper_driver-srv:result instead.")
  (result m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<StepperCmd-response>)))
  ...
  "stepper_driver/StepperCmdResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'StepperCmd-response)))
  "Returns string type for a service object of type 'StepperCmd-response"
  "stepper_driver/StepperCmdResponse")
