...
(cl:in-package stepper_driver-msg)
...
(cl:defclass <StepperArrayMotorHardwareStatus> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (motors_hw_status
    ...
    :type (cl:vector stepper_driver-msg:StepperMotorHardwareStatus)
   :initform (cl:make-array 0 :element-type 'stepper_driver-msg:StepperMotorHardwareStatus :initial-element (cl:make-instance 'stepper_driver-msg:StepperMotorHardwareStatus))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <StepperArrayMotorHardwareStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StepperArrayMotorHardwareStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name stepper_driver-msg:<StepperArrayMotorHardwareStatus> is deprecated: use stepper_driver-msg:StepperArrayMotorHardwareStatus instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <StepperArrayMotorHardwareStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader stepper_driver-msg:header-val is deprecated.  Use stepper_driver-msg:header instead.")
  (header m))
...
(cl:defmethod motors_hw_status-val ((m <StepperArrayMotorHardwareStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader stepper_driver-msg:motors_hw_status-val is deprecated.  Use stepper_driver-msg:motors_hw_status instead.")
  (motors_hw_status m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <StepperArrayMotorHardwareStatus>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'motors_hw_status)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'stepper_driver-msg:StepperMotorHardwareStatus))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<StepperArrayMotorHardwareStatus>)))
  ...
  "stepper_driver/StepperArrayMotorHardwareStatus")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'StepperArrayMotorHardwareStatus)))
  "Returns string type for a message object of type 'StepperArrayMotorHardwareStatus"
  "stepper_driver/StepperArrayMotorHardwareStatus")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<StepperArrayMotorHardwareStatus>)))
  ...
  "74d6dcce2a629b114c5b711b4689c89e")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'StepperArrayMotorHardwareStatus)))
  "Returns md5sum for a message object of type 'StepperArrayMotorHardwareStatus"
  "74d6dcce2a629b114c5b711b4689c89e")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<StepperArrayMotorHardwareStatus>)))
  ...
  (cl:format cl:nil "std_msgs/Header header~%stepper_driver/StepperMotorHardwareStatus[] motors_hw_status~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: stepper_driver/StepperMotorHardwareStatus~%niryo_robot_msgs/MotorHeader motor_identity~%~%string firmware_version~%int32 temperature~%int32 voltage~%int32 error~%~%================================================================================~%MSG: niryo_robot_msgs/MotorHeader~%uint8 motor_id~%~%uint8 motor_type~%uint8 MOTOR_TYPE_STEPPER=1~%uint8 MOTOR_TYPE_XL430=2~%uint8 MOTOR_TYPE_XL320=3~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'StepperArrayMotorHardwareStatus)))
  "Returns full string definition for message of type 'StepperArrayMotorHardwareStatus"
  (cl:format cl:nil "std_msgs/Header header~%stepper_driver/StepperMotorHardwareStatus[] motors_hw_status~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: stepper_driver/StepperMotorHardwareStatus~%niryo_robot_msgs/MotorHeader motor_identity~%~%string firmware_version~%int32 temperature~%int32 voltage~%int32 error~%~%================================================================================~%MSG: niryo_robot_msgs/MotorHeader~%uint8 motor_id~%~%uint8 motor_type~%uint8 MOTOR_TYPE_STEPPER=1~%uint8 MOTOR_TYPE_XL430=2~%uint8 MOTOR_TYPE_XL320=3~%~%~%"))
