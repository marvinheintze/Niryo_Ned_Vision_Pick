...
(cl:defmethod cl:initialize-instance :after ((m <StepperMotorHardwareStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StepperMotorHardwareStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name stepper_driver-msg:<StepperMotorHardwareStatus> is deprecated: use stepper_driver-msg:StepperMotorHardwareStatus instead.")))

(cl:ensure-generic-function 'motor_identity-val :lambda-list '(m))
(cl:defmethod motor_identity-val ((m <StepperMotorHardwareStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader stepper_driver-msg:motor_identity-val is deprecated.  Use stepper_driver-msg:motor_identity instead.")
  (motor_identity m))
...
(cl:defmethod firmware_version-val ((m <StepperMotorHardwareStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader stepper_driver-msg:firmware_version-val is deprecated.  Use stepper_driver-msg:firmware_version instead.")
  (firmware_version m))

(cl:ensure-generic-function 'temperature-val :lambda-list '(m))
(cl:defmethod temperature-val ((m <StepperMotorHardwareStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader stepper_driver-msg:temperature-val is deprecated.  Use stepper_driver-msg:temperature instead.")
  (temperature m))

(cl:ensure-generic-function 'voltage-val :lambda-list '(m))
(cl:defmethod voltage-val ((m <StepperMotorHardwareStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader stepper_driver-msg:voltage-val is deprecated.  Use stepper_driver-msg:voltage instead.")
  (voltage m))

(cl:ensure-generic-function 'error-val :lambda-list '(m))
(cl:defmethod error-val ((m <StepperMotorHardwareStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader stepper_driver-msg:error-val is deprecated.  Use stepper_driver-msg:error instead.")
  (error m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<StepperMotorHardwareStatus>)))
  ...
  "stepper_driver/StepperMotorHardwareStatus")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'StepperMotorHardwareStatus)))
  "Returns string type for a message object of type 'StepperMotorHardwareStatus"
  "stepper_driver/StepperMotorHardwareStatus")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<StepperMotorHardwareStatus>)))
  ...
  "a822d9879fe4fdd38f8e7ef84fced079")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'StepperMotorHardwareStatus)))
  "Returns md5sum for a message object of type 'StepperMotorHardwareStatus"
  "a822d9879fe4fdd38f8e7ef84fced079")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<StepperMotorHardwareStatus>)))
  ...
  (cl:format cl:nil "niryo_robot_msgs/MotorHeader motor_identity~%~%string firmware_version~%int32 temperature~%int32 voltage~%int32 error~%~%================================================================================~%MSG: niryo_robot_msgs/MotorHeader~%uint8 motor_id~%~%uint8 motor_type~%uint8 MOTOR_TYPE_STEPPER=1~%uint8 MOTOR_TYPE_XL430=2~%uint8 MOTOR_TYPE_XL320=3~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'StepperMotorHardwareStatus)))
  "Returns full string definition for message of type 'StepperMotorHardwareStatus"
  (cl:format cl:nil "niryo_robot_msgs/MotorHeader motor_identity~%~%string firmware_version~%int32 temperature~%int32 voltage~%int32 error~%~%================================================================================~%MSG: niryo_robot_msgs/MotorHeader~%uint8 motor_id~%~%uint8 motor_type~%uint8 MOTOR_TYPE_STEPPER=1~%uint8 MOTOR_TYPE_XL430=2~%uint8 MOTOR_TYPE_XL320=3~%~%~%"))
