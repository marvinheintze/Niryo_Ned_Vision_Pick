...
(cl:defmethod cl:initialize-instance :after ((m <StepperMotorCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StepperMotorCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name stepper_driver-msg:<StepperMotorCommand> is deprecated: use stepper_driver-msg:StepperMotorCommand instead.")))

(cl:ensure-generic-function 'cmd_type-val :lambda-list '(m))
(cl:defmethod cmd_type-val ((m <StepperMotorCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader stepper_driver-msg:cmd_type-val is deprecated.  Use stepper_driver-msg:cmd_type instead.")
  (cmd_type m))

(cl:ensure-generic-function 'motors_id-val :lambda-list '(m))
(cl:defmethod motors_id-val ((m <StepperMotorCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader stepper_driver-msg:motors_id-val is deprecated.  Use stepper_driver-msg:motors_id instead.")
  (motors_id m))

(cl:ensure-generic-function 'params-val :lambda-list '(m))
(cl:defmethod params-val ((m <StepperMotorCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader stepper_driver-msg:params-val is deprecated.  Use stepper_driver-msg:params instead.")
  (params m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<StepperMotorCommand>)))
  ...
  "stepper_driver/StepperMotorCommand")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'StepperMotorCommand)))
  "Returns string type for a message object of type 'StepperMotorCommand"
  "stepper_driver/StepperMotorCommand")
